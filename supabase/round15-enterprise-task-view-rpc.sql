-- Enterprise task review workspace RPC alias.
...
drop function if exists get_tasks_by_view_rpc(text, text, int, int);
drop function if exists get_tasks_rpc(text);
drop function if exists get_tasks_rpc(text, text, int, int);
